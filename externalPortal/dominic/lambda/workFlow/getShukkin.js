...
// TODO: 出金申請アプリの実際のアプリIDに置き換える
const SHUKKIN_APP_ID    = process.env.SHUKKIN_APP_ID || 0;
...
exports.handler = async () => {
    ...
    try {
        ...
        console.error('Kintone shukkin getList error:', err);
        throw new Error('出金申請一覧の取得に失敗しました。');
    }
};
